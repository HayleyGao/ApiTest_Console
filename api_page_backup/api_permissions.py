...
def test_permissions(ip,protocol,tenant,Authorization):
    """
    查询租户下用户的权限
    :param ip:
    :param protocol:
    ...
    #url="http://rpa-test.datagrand.com/v2/permissions"
    url = protocol + "://" + ip + '/v2/permissions'
...
if __name__ == '__main__':
    ...
    res=test_permissions(ip,protocol,tenant,Authorization)
